...
;; (repeated (lambda (x) (display x)) 3)
(display 3)
((lambda (x) (display x)) 3)
;;(repeated (lambda (x) (display x)) 5)
    ...
    (lambda (yesno)
      (cond ((and are-they? (eq? yesno #t))
	    ...
	    ((eq? yesno #t)
	     ...
	     (set! > (logoize real->))
	     (set! >= (logoize real->=))
	     (set! abs (logoize real-abs))
	     (set! acos (logoize real-acos))
	     (set! asin (logoize real-asin))
	     (set! atan (logoize real-atan))
	     (set! ceiling (logoize real-ceiling))
	     (set! cos (logoize real-cos))
	     (set! even? (logoize real-even?))
	     (set! exp (logoize real-exp))
	     (set! expt (logoize real-expt))
	     (set! floor (logoize real-floor))
	     (set! align (logoize real-align))
	    ...
	    (else (whoops "String-are-numbers: give a #f or a #t")))
      are-they?)))
